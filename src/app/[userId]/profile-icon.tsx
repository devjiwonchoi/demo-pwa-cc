export function ProfileIcon({ isActive }: { isActive: boolean }) {
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M14.9999 15H8.99991C7.18816 15 5.65774 16.2045 5.16577 17.8564C6.81639 19.7808 9.26577 21 11.9999 21C14.7341 21 17.1834 19.7808 18.8341 17.8564C18.3421 16.2045 16.8117 15 14.9999 15Z"
        stroke={stroke}
        strokeWidth="1.9"
      />
    </svg>
